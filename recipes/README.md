...
| [`SandAI/MAGI-2-preview.md`](./SandAI/MAGI-2-preview.md) | Native Preview-stage text/image-to-video-and-audio generation | 4x or 8x NVIDIA GPUs (TP=1, Ulysses=world) |
