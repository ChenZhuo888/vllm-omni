...
| [`SandAI/MAGI-2-preview.md`](./SandAI/MAGI-2-preview.md) | Native Preview-stage text/image-to-video-and-audio generation | 1x/4x NVIDIA L20X 140 GiB qualified; 8x Hopper configuration-only |
